...
export default function Hero() {
  ...
  <span
    className="
      ...
      tracking-[0.1em]
      text-[#00e6c3]
      drop-shadow-[0_0_16px_rgba(0,230,195,0.4)]
      opacity-0
      animate-[fadeSlideUp_0.8s_ease-out_0.35s_forwards]
      sm:text-5xl
      sm:tracking-[0.14em]
      md:text-6xl
      lg:text-6xl
    ...
    Stephan
            ...
            <div
              className="
                ...
                gap-y-2
                opacity-0
                animate-[fadeSlideUp_0.8s_ease-out_0.55s_forwards]
                sm:gap-x-5
              "
            >
        ...
        PostgreSQL
            ...
            <div
              className="
                ...
                gap-3
                opacity-0
                animate-[fadeSlideUp_0.8s_ease-out_0.85s_forwards]
                sm:w-auto
                sm:flex-row
                sm:flex-wrap
              "
            >
              ...
              <a
                ...
                className="
                  ...
                  transition-all
                  duration-300
                  hover:border-[#00e6c3]/60
                  hover:bg-[#00e6c3]
                  hover:text-black
                  hover:shadow-[0_0_30px_rgba(0,230,195,0.25)]
                "
              >
                Voir mes projets
            ...
            <div
              className="
                ...
                gap-5
                opacity-0
                animate-[fadeSlideUp_0.8s_ease-out_1s_forwards]
              "
            >
          ...
          <div
            className="
              ...
              justify-center
              opacity-0
              animate-[fadeSlideUp_1s_ease-out_0.5s_forwards]
              sm:min-h-[500px]
              lg:min-h-[600px]
            "
          >
            ...
            <div
              className="
                ...
                bg-[#080e0f]
                p-2
                shadow-[0_0_50px_rgba(0,230,195,0.12)]
                sm:h-[340px]
                sm:w-[340px]
                sm:p-2.5
                lg:h-[370px]
            ...
            <div
              className="
                ...
                px-4
                py-3
                shadow-[0_0_25px_rgba(0,230,195,0.08)]
                backdrop-blur-md
                sm:right-[4%]
                sm:px-5
                sm:py-3.5
